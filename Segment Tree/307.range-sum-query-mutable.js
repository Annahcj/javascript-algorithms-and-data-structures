...
// Runtime on LeetCode: 634ms
// Memory Usage on LeetCode: 95.8MB
  ...
  // A few test cases 
  let arr = new NumArray([1,2,5,7]);
  arr.update(0, 1);
  console.log(arr.sumRange(0,3)) // 15
  arr.update(1,10);
  console.log(arr.sumRange(0,3)) // 23
  console.log(arr.segTree)